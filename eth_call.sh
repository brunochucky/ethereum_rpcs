...
curl --data '{"jsonrpc":"2.0","method":"eth_call","params":[{"from":'$_arg_wallet_from',"to":'$_arg_wallet_to',"value":'$_arg_value'},"gas":'$_arg_gas'],"id":0}' -H "Content-Type: application/json" -X POST $_arg_server