...
print_help()
{
	...
	printf 'Usage: %s [-i|--id <arg>] [-s|--server <arg>] [-f|--wallet_from <arg>] [-t|--wallet_to <arg>] [-v|--value <arg>] [-g|--gas <arg>] [-p|--gasprice <arg>] [-d|--data <arg>] [-h|--help]\n' "$0"
...
curl --data '{"jsonrpc":"2.0","method":"eth_call","params":[{"from":"'$_arg_wallet_from'","to":"'$_arg_wallet_to'","value":"'$_arg_value'","gas":"'$_arg_gas'","gasPrice":"'$_arg_gasPrice'","data":"'$_arg_data'"}],"id":'$_arg_id'}' -H "Content-Type: application/json" -X POST $_arg_server